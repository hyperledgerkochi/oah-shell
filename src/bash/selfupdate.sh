...
# # OAH_INSTALLER_SERVICE="https://raw.githubusercontent.com/hyperledgerkochi/oah-installer/"
# # #sOAH meta data service for validated OAH environments
# # #OAH_ENVS_INFO_SERVICE="@OAH_ENVS_INFO_SERVICE@"
# #
# # OAH_ENVS_INFO_SERVICE="https://raw.githubusercontent.com/hyperledgerkochi/oah-installer/master/envsinfo/candidates.txt"
# # #OAH_BROADCAST_SERVICE="@OAH_BROADCAST_SERVICE@"
# # OAH_BROADCAST_SERVICE="https://raw.githubusercontent.com/hyperledgerkochi/oah-installer/master/broadcast/"
# # #OAH_VERSION=0.0.1a1
# # OAH_VERSION="0.0.1a1"
# # OAH_DIR="$HOME/.oah"
# #
